...
CHAPA_API = env('CHAPA_URL', default='https://api.chapa.co/v1')
FRONTEND_URL = env('FRONTEND_URL', default='http://localhost:3000')
CHAPA_SECRET_KEY = env('CHAPA_SECRET_KEY')
CHAPA_PUBLIC_KEY = env('CHAPA_PUBLIC_KEY')
CHAPA_TEST_MODE = env.bool('CHAPA_TEST_MODE', default=True)
CHAPA_LIVE_MODE = env.bool('CHAPA_LIVE_MODE', default=False)
...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='khalfanathman12@gmail.com')
